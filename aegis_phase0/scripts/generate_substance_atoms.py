#!/usr/bin/env python3
"""
AEGIS Rule Bulk Loader — CSV to ASP Atoms
==========================================

Generates ASP atom files from CSV data sources for list-based regimes.
Handles ~70% of AEGIS rule volume (substance lists, entity lists, etc.).
...
REGIME_CONFIGS = {
    ...
    "cwc_schedule_1": RegimeConfig(
        ...
        output_file="src/aegis/reasoning/rules/cwc/schedule_1_generated.lp",
        regime_name="cwc",
        schedule_value="1",
    ...
    "cwc_schedule_2": RegimeConfig(
        ...
        output_file="src/aegis/reasoning/rules/cwc/schedule_2_generated.lp",
        regime_name="cwc",
        schedule_value="2",
    ...
    "cwc_schedule_3": RegimeConfig(
        ...
        output_file="src/aegis/reasoning/rules/cwc/schedule_3_generated.lp", 
        regime_name="cwc",
        schedule_value="3",
    ...
    "dea_schedule_i": RegimeConfig(
        ...
        output_file="src/aegis/reasoning/rules/dea/schedule_i_generated.lp",
        regime_name="dea", 
        schedule_value="I",
    ...
    "dea_schedule_ii": RegimeConfig(
        ...
        output_file="src/aegis/reasoning/rules/dea/schedule_ii_generated.lp",
        regime_name="dea",
        schedule_value="II", 
    ...
    "dea_schedule_iii_v": RegimeConfig(
        ...
        output_file="src/aegis/reasoning/rules/dea/schedule_iii_v_generated.lp",
        regime_name="dea",
    ...
    "hhs_select_agents": RegimeConfig(
        ...
        output_file="src/aegis/reasoning/rules/bwc_select_agents/hhs_select_agents_generated.lp",
    ...
    "usda_select_agents": RegimeConfig(
        ...
        output_file="src/aegis/reasoning/rules/bwc_select_agents/usda_select_agents_generated.lp", 
    ...
    "australia_group_bio": RegimeConfig(
        ...
        output_file="src/aegis/reasoning/rules/bwc_select_agents/australia_group_bio_generated.lp",
    ...
    "bis_entity_list": RegimeConfig(
        ...
        output_file="src/aegis/reasoning/rules/ear/bis_entity_list_generated.lp",
